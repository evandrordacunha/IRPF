...
public class DeclaracaoFacadeTest {
	...
	@Test
	/**
	 * Testa o método InstanciarContribuinte() e verifica, se criar um
	 * contribuinte normalmente retorna TRUE e passa no teste, se retornar NULL,
	 * não passa.
	 */

	public void testInstanciarContribuinte() {
		assertTrue(dF.instanciarContribuinte(tNome, tCpf, tIdade, tContribuicaoOficial, tTotalRendimentos,
				tDependentes) != null);
	}

	@Test
	/**
	 * Testa o método InstanciarDeclaracao() e verifica, se criar uma declaração
	 * normalmente, (diferente de NULL), retorna true e passa no teste.
	 */
