...
public class DeclaracaoTest {
	 ...
	 * não pode ser diferente de 37400, nem menor que 37399 e nem maior que
	 * 37401.
	 */
	...
	/**
	 * Testa se alguém alterou a fórmula, sendo que o resultado para o cálculo
	 * não pode ser menor que 6459 para esse cliente que tem como base de
	 * cálculo 43100. (Valor do cálculo = 6459,87)
	 */
	...
	/**
	 * Testa se alguém alterou a fórmula, sendo que o resultado para o cálculo
	 * não pode ser menor que 4970 para esse cliente que tem como base de
	 * cálculo 37400. (Valor do cálculo = 4970,75)
	 */
	@Test
	...
	@Test
	/**
	 * Valor pago de IR é 4970,75, forçamos a alteração para 5000,00 e usamos o
	 * método Get para verificar se ocorreu realmente a alteração trazendo falso
	 * se o valor continua o antigo entre 4970 e 4971.
	 */
	 ...
	 * que faz mensão ao tipo de declaração. Esse método é usado apenas para
	 * converter o caractere recebido na plavra que identifica o tipo de
	 * declaração.
	 */
	 ...
	 * retorna TRUE, do contrário, o método não está buscando as informações da
	 * declaração.
	 */
